...
/**
 * IzanagiWorldGuard; com.izanagicraft.guard:GuardConstants
 * <p>
 * A utility class containing constants related to the IzanagiWorldGuard plugin.
 * <p>
 * This class provides constants for chat prefixes, colors, headers, and footers used
 * throughout the plugin. These constants can be easily accessed and reused in various
 * parts of the code for consistent styling and messaging.
 *
